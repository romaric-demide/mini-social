...
CREATE TABLE "Hide" (
    ...
    CONSTRAINT "Hide_pkey" PRIMARY KEY ("userId","postId")
);
...
-- AddForeignKey
ALTER TABLE "Hide" ADD CONSTRAINT "Hide_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;
